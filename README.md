# 우아한 테크코스 자동차 경주(실험적 기능 브랜치)

## 레이싱 카 게임 🏎️

이 프로젝트는 우아한형제들 프리코스에서 제공된 과제로, spoyodevelop 제출용 branch 내용과 다르게, 실험적인 기능을 담고 있습니다. 경주가 너무 오랫동안 진행되는 것을 막기 위해, runRounds가 5초 이상 진행되면 error를 던져 프로그램을 멈춥니다.
