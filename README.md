# 우아한 테크코스 자동차 경주(깊은 추상화 버전)

## 레이싱 카 게임 🏎️

이 프로젝트는 우아한형제들 프리코스에서 제공된 과제로, Dependency injection을 비롯한 추상화 레이어가 보강된 branch 입니다. 깊은 추상화 레벨을 구경할수 있습니다.
...
5. **추상화 레이어**
   - Service와 dependency injection 같은 추가적인 추상화 레이어를 구현했습니다. 문제가 발생했을때 코드가 더 유연하게 대처 할수 있게 합니다.
